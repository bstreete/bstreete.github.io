...
.. date: 2019-12-23T14:51:20-07:00
.. tags: entree, soup, slow cooker, vegetarian, favorites
.. category: recipes
.. author: Budget Bytes
.. link: https://www.budgetbytes.com/slow-cooker-black-bean-soup
.. description: 
.. type: text
///
...
**Strongly recommend using an immersion blender instead of a countertop blender for safety.** 
Taste the soup and add salt if needed (this will depend on the brand of vegetable broth used).
