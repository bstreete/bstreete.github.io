...
BLOG_AUTHOR = "Brayden Streeter"  # (translatable)
...
#         ("/categories/cat_recipes/", "Recipes"),
#         ('https://github.com/bstreete/', 'My Github'),
#         ('/rss.xml', 'RSS'),
#     ),
# }

## Hybrid theme style with icons
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
...
## Hybrid themes - based on Hugo's Hyde themes
THEME_CONFIG = {
    DEFAULT_LANG: {
...
CATEGORY_TITLES = {
   DEFAULT_LANG: {
       ...
       "resources": "Interesting Recipes",
       "masters": "Category Pages",
   },
}
